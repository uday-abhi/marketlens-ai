...
/**
 * Simple DTO for dashboard overview data.
 * DTO = Data Transfer Object - carries data between layers.
 * No Lombok - we write getters/setters manually for learning.
 */
public class DashboardOverviewResponse {
    ...
    public DashboardOverviewResponse(int fearGreed, String fearGreedLabel, double btcDominance,
                                     String marketCap, double marketCapChange, String volume24h,
                                     double volumeChange, double btcPrice, double btcChange,
                                     String marketTrend) {
    ...
    public int getFearGreed() { return fearGreed; }
    public void setFearGreed(int fearGreed) { this.fearGreed = fearGreed; }
    ...
    public double getMarketCapChange() { return marketCapChange; }
    public void setMarketCapChange(double marketCapChange) { this.marketCapChange = marketCapChange; }

    public String getVolume24h() { return volume24h; }
    public void setVolume24h(String volume24h) { this.volume24h = volume24h; }

    public double getVolumeChange() { return volumeChange; }
    public void setVolumeChange(double volumeChange) { this.volumeChange = volumeChange; }

    public double getBtcPrice() { return btcPrice; }
    public void setBtcPrice(double btcPrice) { this.btcPrice = btcPrice; }

    public double getBtcChange() { return btcChange; }
    public void setBtcChange(double btcChange) { this.btcChange = btcChange; }
